...
| **F7** Georeferencované PDF podklady (Dalux „Locations") | 🟢 v implementácii | D-072; balík `@ifc-lite/drawing-underlay` + bridge + `_georef`; míľniky M0–M4 |
