...
insert into rel_aggregates (id, from_id, to_id, source) values
  ...
  -- floors → building
  ('e1000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000002', 'seed'),
  ('e1000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000002', 'seed'),
  -- spaces → floors
...
insert into rel_contained_in_spatial_structure (id, from_id, to_id, source) values
  ...
  ('e1000000-0000-0000-0000-0000000000a3', 'a0000000-0000-0000-0000-0000000000a3', 'a0000000-0000-0000-0000-000000000022', 'seed')   -- CERP-01 → strojovňa 1.02
on conflict (id) do nothing;
...
-- -----------------------------------------------------------------------------
-- 10. rel_member_of (D-024) — osoba → organizácia
-- -----------------------------------------------------------------------------
insert into rel_member_of (id, from_id, to_id, role, source) values
  ('e3000000-0000-0000-0000-0000000000b1', 'a0000000-0000-0000-0000-0000000000b1', 'a0000000-0000-0000-0000-0000000000b0', 'Facility Manager', 'seed')
on conflict (id) do nothing;
